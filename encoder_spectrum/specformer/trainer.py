#trainer script taken from AstroCLIP
...
'''
this trainer wrapper is used to customize:
1. save config to wandb
2. change the lr_scheduler interval to step instead of epoch
'''
