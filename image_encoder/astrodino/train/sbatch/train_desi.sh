...
#SBATCH --mem=500000
#SBATCH --output=/ptmp/yacheng/outthere_ssl/train_desi_vitl-%j.log
...
run_name="astrodino_desi_vitl"
config="/ptmp/yacheng/outthere_ssl/AstroCLIP/configs/astrodino_desi_vitl.yaml"
