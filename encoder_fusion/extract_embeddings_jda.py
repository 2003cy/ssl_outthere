"""Extract CLS embeddings from image and spectrum encoders for JDA fusion training.

Data source: images/JDA/jda_spectra_low_image.h5
...
Usage (from encoder_image/astrodino so sys.path picks up dinov2 + preprocessing):
    ...
    XFORMERS_DISABLED=1 python ../../encoder_fusion/extract_embeddings_jda.py
"""
...
class JDAImageDataset(Dataset):
    """Load images from jda_spectra_low_image.h5  (flat key: "image")."""
...
class JDASpectrumDataset(Dataset):
    """Load flux/wave from jda_spectra_low_image.h5  (flat keys: "flux", "wave")."""
...
def main():
    ...
    spec_ds     = JDASpectrumDataset(JDA_H5)
